...
class Controller_Customers extends Controller_View {
	...
	function before()
	{
		...
		if( ! Session::instance()->get('tab_section') ) {
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'customers/invoices',
				'text' => 'Invoices',
				'text_short' => 'Inv',
				'removable' => FALSE
			);
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'customers/payments',
				'text' => 'Payments',
				'text_short' => 'Pay',
				'removable' => FALSE
			);
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'customers/customers',
				'text' => 'Customers',
				'text_short' => 'Cust',
				'removable' => FALSE
			);
		...
		$this->addScript('/static/js/customers.js');
	}

	public function action_index()
	{
		// Forward to sales.	
		$this->redirect("/customers/sales/");
	}
