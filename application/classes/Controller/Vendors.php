...
class Controller_Vendors extends Controller_View {
	...
	function before() {
		...
		if( ! Session::instance()->get('tab_section') ) {
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'vendors/expenses',
				'text' => 'Expenses',
				'removable' => FALSE,
				'text_short' => 'Exp',
			);
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'vendors/purchases',
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'vendors/invoices',
				'text' => 'Age Invoices',
				'removable' => FALSE,
				'text_short' => 'Inv',
			);
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'vendors/payments',
				'text' => 'Pay Invoices',
				'removable' => FALSE,
				'text_short' => 'Pay',
			);
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'vendors/taxpayments',
			...
			$tab_links[] = array(
				'url' => ROOT_WDIR . 'vendors/printchecks',
		...
		$this->addScript('/static/js/vendors.js');
	...
	{
		// Forward to invoices.	
		$this->redirect("/vendors/expenses/");
	}
