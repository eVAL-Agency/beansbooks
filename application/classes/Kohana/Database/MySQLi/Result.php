...
class Kohana_Database_MySQLi_Result extends Database_Result {
	...
	public function current()
	{
		...
		elseif (is_string($this->_as_object))
		{
			...
			// Fix the PHP 7 bug when they changed how fetch_object behaves internally
			// https://github.com/kohana/orm/issues/129
			...
			if(method_exists($object, 'load')){
				...
				if (isset(class_parents($object)['ORM']) AND method_exists($object,'verify_loaded')){
					$object->verify_loaded();
				}
			}
